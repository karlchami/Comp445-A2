...
def nick_cmd(decoded_request, server, client_connection, user_connection_info):
    ...
    return response_builder(decoded_request, "ERR_NICKCOLLISION", "An error has occurred")
...
def user_cmd(decoded_request, server, client_connection, user_connection_info):
    ...
    return response_builder(decoded_request, "ERR_ALREADYREGISTRED", "An error has occurred")
